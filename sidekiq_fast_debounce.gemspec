...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/Latermedia/sidekiq_fast_debounce'
    spec.metadata['changelog_uri'] = 'https://github.com/Latermedia/sidekiq_fast_debounce/blob/master/CHANGELOG.md'
  else
